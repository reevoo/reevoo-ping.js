...
import Embeddable from "./events/embeddable"
...
class Client {
  constructor(appId, opts = {}, trackerConfig = {}, win = window) {
    ...
    this.trackEvent = ({ type, trkref, ...properties }) => {
      if (!type) {
        // eslint-disable-next-line no-console
        return console.error('[reevoo-ping] trackEvent: You have to pass object with type property')
      }
    ...
    this.embeddable = new Embeddable(boundedTracker, opts.trkref)
