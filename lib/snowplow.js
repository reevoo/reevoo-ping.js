...
// TODO: Magic strings -> Config.
const snowplowCollectorURI = 'https://ping.reevoo.com';
...
if(!window[snowplowFunctionName]) {
  ...
  window[snowplowFunctionName] = function() {
...
window[snowplowFunctionName]('newTracker', 'cf', snowplowCollectorURI, snowplowConfig);

window[snowplowFunctionName](function() {
  console.log("Snowplow loaded.");
});
