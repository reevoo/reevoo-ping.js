...
const EVENT_TYPES = ['rendered', 'updated', 'seen', 'clicked', 'scrolled', 'closed']
const CONTENT_TYPES = ['product', 'brand', 'conversations', 'combo', 'offer', 'conversation_response']
